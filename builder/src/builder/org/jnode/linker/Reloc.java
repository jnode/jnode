...
public class Reloc {
	/**
	 * Relocation item typedef struct { Elf32_Addr r_address; relative to
	 * _start_ of section Elf32_Word r_symbol; ELF symbol info thingy }
	 * Elf32_Reloc;
	 */
	...
	static final String[] typename = { null, "abs32", "pcrel32", "GOT32",
			"PLT32", null, null, null, null, "GOTOFF", "GOTPC" };
	...
	private Reloc(Elf elf, Symbol symbol, long address, int type) {
		this.elf = elf;
