...
public class Container extends Component {
	...
	protected void addImpl(Component comp, Object constraints, int index) {
		synchronized (getTreeLock()) {
			if (index > ncomponents
				...
				|| (comp instanceof Container && ((Container) comp).isAncestorOf(this)))
			...
			ContainerEvent ce = new ContainerEvent(this, ContainerEvent.COMPONENT_ADDED, comp);
	...
	public void remove(int index) {
		synchronized (getTreeLock()) {
			...
			// Post event to notify of adding the container.
			ContainerEvent ce = new ContainerEvent(this, ContainerEvent.COMPONENT_REMOVED, r);
			getToolkit().getSystemEventQueue().postEvent(ce);
		}
	}
