...
public class Window extends Container {
	...
	public Window(Window owner, GraphicsConfiguration gc) {
		...
		*/
		...
		if (gc != null && gc.getDevice().getType() != GraphicsDevice.TYPE_RASTER_SCREEN)
	...
	*/
	...
	public synchronized WindowListener[] getWindowListeners() {
		return (WindowListener[]) AWTEventMulticaster.getListeners(windowListener, WindowListener.class);
	}
	...
	void dispatchEventImpl(AWTEvent e) {
		...
		if (e.id <= WindowEvent.WINDOW_LAST && e.id >= WindowEvent.WINDOW_FIRST && (windowListener != null || (eventMask & AWTEvent.WINDOW_EVENT_MASK) != 0))
			processEvent(e);
		else
