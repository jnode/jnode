...
public class WritableRaster extends Raster {
	...
	public WritableRaster createWritableTranslatedChild(int childMinX, int childMinY) {
		...
		return new WritableRaster(sampleModel, dataBuffer, new Rectangle(childMinX, childMinY, width, height), new Point(tcx, tcy), this);
	}
	...
	public void setDataElements(int x, int y, Raster inRaster) {
		Object dataElements = getDataElements(0, 0, inRaster.getWidth(), inRaster.getHeight(), null);
