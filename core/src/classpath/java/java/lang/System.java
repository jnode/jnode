...
public final class System {
    ...
    /**
     * A private method used only by the VM as a bootstrap point into the Java
     * libraries.
     * <p>
     * This function will be called after the initial thread group and thread
     * are created, but before they go off and do their own thing. It can do
     * whatever is necessary to initialize the system.
     */
     ...
     * RuntimePermission("setSecurityManager") permission to ensure it's ok to
     ...
     * If the argument is null and no security manager has been established,
     * then no action is taken and the method simply returns.
     * 
     * @param s
     */
     ...
     * convolution of the pointer to the Object internal to the VM. It follows
     * standard hash code rules, in that it will remain the same for a given
