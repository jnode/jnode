...
/**
 * This class is a heterogeneous collection of permissions. It is organized as
 * a collection of <code>PermissionCollection</code>'s stored in a
 * hashtable. Each individual <code>PermissionCollection</code> contains
 * permissions of a single type. If a specific type of <code>Permission</code>
 * does not provide a collection type to use via its <code>newPermissionCollection</code>
 * method, then a default collection type which stores its permissions in a
...
public final class Permissions extends PermissionCollection implements
     ...
     * will be stored in a <code>PermissionCollection</code> of the
     * appropriate type, as determined by calling <code>newPermissionCollection</code>
     * on the specified permission (if an appropriate collection does not
     * already exist). If this object does not specify a particular type of
     * collection, a default collection, which stores in permissions in a hash
     * table, will be used.
     * 
     * @param perm
     *            the <code>Permission</code> to add
     * @throws SecurityException
     *             if this collection is marked as read only
     */
    public void add(Permission perm) {
        if (isReadOnly()) { throw new SecurityException(
                "PermissionCollection is read only"); }
        ...
        if (perm instanceof AllPermission) {
            ...
            PermissionCollection pc = (PermissionCollection) perms
                    .get(permClass);
            if (pc == null) {
    ...
    public boolean implies(Permission perm) {
        if (allPermission != null) { return true; }
        final PermissionCollection pc = (PermissionCollection) perms.get(perm
                .getClass());
        if (pc == null) {
            return false;
        } else {
    ...
    /**
     * This method returns an <code>Enumeration</code> which contains a list
     * of all <code>Permission</code> objects contained in this collection.
     * 
    ...
    public Enumeration elements() {
        return new Enumeration() {
            ...
            public boolean hasMoreElements() {
                if (sub_enum == null) {
                    if (main_enum == null) return false;
                    if (!main_enum.hasMoreElements()) {
                        main_enum = null;
                        return false;
                    }
                    PermissionCollection pc = (PermissionCollection) main_enum
                            .nextElement();
