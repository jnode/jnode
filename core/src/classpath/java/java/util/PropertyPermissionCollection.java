...
/**
 * This class provides the implementation for <code>PropertyPermission.newPermissionCollection()</code>.
 * It only accepts PropertyPermissions, and correctly implements <code>implies</code>.
 * It is synchronized, as specified in the superclass.
 * 
 * @author Eric Blake <ebb9@email.byu.edu>@status an undocumented class, but
 *         this matches Sun's serialization
 */
class PropertyPermissionCollection extends PermissionCollection {
     ...
     *             if permission is not a PropertyPermission
     ...
     * <p>", "read")); ", "write")); collection.implies(new
     * PropertyPermission("a.b.c", "read,write"));
     * 
     * </pre>
     * 
     * @param permission
    ...
    public boolean implies(Permission permission) {
        ...
        final PropertyPermission toImply = (PropertyPermission) permission;
        ...
        while (true) {
            PropertyPermission forName = (PropertyPermission) permissions
                    .get(name);
            if (forName != null) {
