...
/**
 * Class. If you change any fields in this class, also change <code>emitClass</code>
...
public final class Class<T> implements Serializable {
    ...
    public Class(VmType vmClass) {
        if (vmClass == null) { throw new IllegalArgumentException(
                "vmClass cannot be null"); }
     ...
     * of this Class as well. Think of doing <code>isInstance(c.newInstance())</code>
     * or even <code>c.newInstance() instanceof (this class)</code>. While
     * this checks widening conversions for objects, it must be exact for
     * primitive types.
     * 
     * @param c
     *            the class to check
    ...
    public final Object newInstance() throws InstantiationException,
        ...
        if (defaultConstructor == null) {
            defaultConstructor = getLinkedVmClass().getDeclaredMethod("<init>", "()V");
        }
        try {
    ...
    public Class getComponentType() {
        ...
        if (vmClass instanceof VmArrayClass) {
            final VmType vmCompType = ((VmArrayClass) vmClass)
                    .getComponentType();
            if (vmCompType != null) { return vmCompType.asClass(); }
        }
        return null;
    }
    ...
    public Method getDeclaredMethod(String name, Class[] argTypes)
        ...
        VmMethod method = getLinkedVmClass().getDeclaredMethod(name, vmArgTypes);
        if (method != null) {
            return (Method) method.asMember();
        } else {
            throw new NoSuchMethodException(name);
    ...
    /**
     * Returns an array of all public classes and interfaces that are members 
     * of this class and declared in this class.
     * @return
     */
     ...
     * of another class, returns the Class object representing the class in 
     * which it was declared. 
     * This method returns null if this class or interface is not a 
     * member of any other class. If this Class object represents an array 
    ...
    public Constructor getDeclaredConstructor(Class[] argTypes) throws NoSuchMethodException {
        String signature = Signature.toSignature(null, argTypes);
        final VmMethod vmMethod = getLinkedVmClass().getDeclaredMethod("<init>", signature);
        if (vmMethod != null) {
     ...
     * 
     * Null is returned if no package object was created by the class loader of
     * this class. Packages have attributes for versions and specifications
     * only if the information was defined in the manifests that accompany the
     * classes, and if the class loader created the package instance with the
    ...
    public Constructor getConstructor(Class[] argTypes)
            throws NoSuchMethodException {
        String signature = Signature.toSignature(null, argTypes);
        final VmMethod vmMethod = getLinkedVmClass().getMethod("<init>", signature);
        if (vmMethod != null) {
            return (Constructor) vmMethod.asMember();
        } else {
            throw new NoSuchMethodException("<init> " + signature);
     ...
     * or if the class is an array class, or if the class reflects a primitive
     * type or void.
     * 
     * If there is a security manager, this method first calls the security
     * manager's checkMemberAccess method with this and Member.PUBLIC as its
     * arguments. If the class is in a package, then this method also calls the
     * security manager's checkPackageAccess method with the package name as
     * its argument. Either of these calls could result in a SecurityException.
     * 
     * @return Constructor[]
     */
     ...
     * 
     * @param type
     * @return @see VmType#getPrimitiveClass(char)
     */
