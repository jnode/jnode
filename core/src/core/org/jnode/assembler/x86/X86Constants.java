...
public interface X86Constants {
	...
	public static final int REGNORM = 0x00201000; /*
													 * 'normal' reg, qualifies
													 * as EA
													 */
	...
	public static final int FPUREG = 0x01000000; /*
	...
	public static final int REG_ACCUM = 0x00211000; /*
	...
	public static final int REG_DESS = 0x02081002; /*
													 * DS, ES, SS (non-CS 86
													 * registers)
													 */

	public static final int REG_FSGS = 0x04081002; /*
													 * FS, GS (386 extended
													 * registers)
													 */

	public static final int REG_SEG67 = 0x08081002; /*
													 * Non-implemented segment
													 * registers
													 */
	...
	public static final class Mode {
		...
		/** Use 32-bit code */
		public static Mode BITS32 = new Mode(32);

		/** Use 64-bit code */
		public static Mode BITS64 = new Mode(64);
