...
public class BytecodeParser {
	...
	/*
	 * The following value must not be changed. The native code of interpreter jumptables depend on
	 * them.
	 */
	 ...
	 */
	public static void parse(VmByteCode bc, BytecodeVisitor handler) throws ClassFormatError {
	 ...
	 * @throws ClassFormatError
	 */
	public static void parse(VmByteCode bc, BytecodeVisitor handler, int startPC, int endPC, boolean startEndMethod) throws ClassFormatError {
	 ...
	 * @throws ClassFormatError
	 */
	public void parse(int startPC, int endPCArg, boolean startEndMethod) throws ClassFormatError {
		...
		while (offset < endPC) {
			...
			switch (opcode) {
				...
				case 0x13 :
					...
					// -- 20 --
				case 0x14 :
					handler.visit_ldc2(cp.getAny(getu2()));
					break;
				case 0x15 :
						...
						if (opcode == 0x84) {
							...
							switch (opcode) {
								...
								case 0x3a :
									...
									break;
								default :
									throw new ClassFormatError("Invalid opcode in wide instruction");
							}
						}
					}
					break;
