...
public class VmDefaultHeap extends VmAbstractHeap implements ObjectFlags {
	 ...
	 * @return the heap
	 */
	protected static VmAbstractHeap setupHeap(HeapHelper helper, Address start, VmNormalClass heapClass, int slotSize) {
		final int headerSize = ObjectLayout.objectAlign((ObjectLayout.HEADER_SLOTS + 1) * slotSize);
		...
		final int heapObjSize = ObjectLayout.objectAlign(heapClass.getObjectSize());
