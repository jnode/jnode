...
class X86BytecodeVisitor extends InlineBytecodeVisitor implements
	...
	private final FPBytecodeVisitor fpCompiler;
	...
	public X86BytecodeVisitor(NativeStream outputStream, CompiledMethod cm,
		...
		this.fpCompiler = new FPBytecodeVisitorFPU(this, os, eContext, vstack,
				arrayDataOffset);
	}
	...
	private final void instanceOfClass(X86Register objectr, VmClassType type,
			X86Register tmpr, X86Register resultr, Label trueLabel,
			boolean skipNullTest) {
	...
	private final void instanceOf(X86Register objectr, X86Register typer,
			X86Register tmpr, X86Register cntr, Label trueLabel,
			boolean skipNullTest) {
	...
	public final void visit_checkcast(VmConstClass classRef) {
		...
		if (resolvedType.isInterface() || resolvedType.isArray()) {
			...
			final X86Register cntr = L1AHelper.requestRegister(eContext,
					JvmType.INT, false);
			final X86Register tmpr = L1AHelper.requestRegister(eContext,
					JvmType.INT, false);
