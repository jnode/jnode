...
public class SetupPacket extends USBPacket implements USBConstants {
	 ...
	 */
	public static SetupPacket createGetDescriptorPacket(int reqType, int descrType, int index, int langId, int descrLength) {
		return new SetupPacket(USB_DIR_IN | reqType, USB_REQ_GET_DESCRIPTOR, (descrType << 8) | index, langId, descrLength);
	}
