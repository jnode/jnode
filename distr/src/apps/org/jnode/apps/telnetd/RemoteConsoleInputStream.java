...
public class RemoteConsoleInputStream {
    /*
     * private static final int CR = 0x0D; private static final int LF =
     * BasicTerminalIO.ENTER;
     * 
     * private final BasicTerminalIO terminalIO; private boolean echo = true;
     * private final ScrollableTextScreenConsole scrollable; private boolean
     * foundLF = false;
     * 
     * 
     * public RemoteConsoleInputStream(BasicTerminalIO terminalIO,
     * ScrollableTextScreenConsole scrollable) { this.terminalIO = terminalIO;
     ...
     * BasicTerminalIO.UP) // { // scrollable.scrollUp(1); // } // else if(ch ==
     * BasicTerminalIO.DOWN) // { // scrollable.scrollDown(1); // } // else // {
