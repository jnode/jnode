	...
	public FileDeviceView() throws Exception
	{
		...
		addFakeDiskButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent event) {
				FileDeviceView.this.fileDevices.add(DeviceUtils.createFakeDevice(FileDeviceView.this.errorReporter));
			}
		});
		addVMWareDiskButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent event) {
				FileDeviceView.this.fileDevices.add(DeviceUtils.createVMWareDevice(FileDeviceView.this.errorReporter));
			}
		});
