...
/**
 * Attribute stored ZLIB compressed data.
 *
 * @author Luke Quinane
 */
public class AttributeZlibCompression implements HfsPlusCompression {
     ...
     */
    public AttributeZlibCompression(AttributeData attributeData, DecmpfsDiskHeader decmpfsDiskHeader) {
