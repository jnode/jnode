...
public class ISO9660Volume {
    ...
    public void initVolumeDescriptors() throws IOException {
        ...
        while (true) {
            // read the LB
            this.readFromLBN(currentLBN, 0, buff, 0,
                    ISO9660FileSystem.DefaultLBNSize);
    ...
    public void readFromLBN(long startLBN, long offset, byte[] buffer,
        ...
        api.read((startLBN * ISO9660FileSystem.DefaultLBNSize) + offset,
