...
public class FatName {
    private static final Logger log =
        Logger.getLogger ( FatName.class );
    ...
    FatName ( FatDirectory parent, String name )
	throws IOException {
	...
	/*
	log.debug ( "lossy\t[" + lossy + "]" );
	log.debug ( "stripped\t[" + stripped + "]" );
        log.debug ( "fit\t\t[" + fit + "]" );
        log.debug ( "basis\t<" + decoder.decode ( basis ) + ">" );
	*/
	...
	return
	    stripChar ( stripChar ( name, space, false ),  period, true  );
    }
