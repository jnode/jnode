...
import org.jnode.driver.floppy.FloppyDriveParametersCommand;
import org.jnode.driver.floppy.FloppyDriver;
import org.jnode.driver.floppy.FloppyIdCommand;
import org.jnode.driver.floppy.FloppyParameters;
import org.jnode.driver.floppy.FloppyReadSectorCommand;
import org.jnode.driver.floppy.FloppySeekCommand;
import org.jnode.driver.floppy.FloppyWriteSectorCommand;
...
//            invocation.invokedMethod.invoke(invocation.invokedObject, new Object[]{invocation.parameterValues.get(0)});
...
//                        new SetDriverStub());
                ...
                //mockFloppyDevice.expects(testCase.once()).method("setDriver").with(new IsInstanceOf(FloppyDriver.class));
    ...
    public FloppyDriveParametersCommand createFloppyDriveParametersCommand(int drive, FloppyDriveParameters dp, FloppyParameters fp)
    {
        ...
        FloppyDriveParametersCommand cmd = (FloppyDriveParametersCommand) MockUtils.createMockObject(FloppyDriveParametersCommand.class, initializer, argCls, args);
        return cmd;
    }
...
//                        will(new ReturnStub(driver));
        ...
        FloppySeekCommand cmd = (FloppySeekCommand) MockUtils.createMockObject(FloppySeekCommand.class, initializer, argCls, args);
        return cmd;
    }
    ...
    {
        Class[] argCls = new Class[]{int.class, Geometry.class, CHS.class, int.class, boolean.class, int.class, byte[].class, int.class};
        Object[] args = new Object[]{new Integer(drive), geometry, chs, new Integer(currentSectorSize), Boolean.valueOf(b), new Integer(gap1Size), dest, new Integer(destOffset)};        
        MockInitializer initializer = new MockInitializer()
        {
            public void init(Mock mockCmd)
            {
        ...
        FloppyReadSectorCommand cmd = (FloppyReadSectorCommand) MockUtils.createMockObject(FloppyReadSectorCommand.class, initializer, argCls, args);
        return cmd;
    }
    ...
    {
        Class[] argCls = new Class[]{int.class, Geometry.class, CHS.class, int.class, boolean.class, int.class, byte[].class, int.class};
        Object[] args = new Object[]{new Integer(drive), geometry, chs, new Integer(currentSectorSize), Boolean.valueOf(b), new Integer(gap1Size), src, new Integer(srcOffset)};        
        MockInitializer initializer = new MockInitializer()
        {
            public void init(Mock mockCmd)
            {
        ...
        FloppyWriteSectorCommand cmd = (FloppyWriteSectorCommand) MockUtils.createMockObject(FloppyWriteSectorCommand.class, initializer, argCls, args);
        return cmd;
    }
    ...
    public FloppyIdCommand createFloppyIdCommand(int drive)
    {
        ...
        FloppyIdCommand cmd = (FloppyIdCommand) MockUtils.createMockObject(FloppyIdCommand.class, initializer, argCls, args);
        return cmd;
    }    
}
