...
*/
    ...
    private List<FSTestConfig> createFileConfigs(OsType osType, FSType fsType,
            FSAccessMode accessMode, Formatter<? extends FileSystem> formatter, String fileSize, String fileName)
    {
    ...
    private List<FSTestConfig> createConfigs(OsType osType, FSType fsType,
            FSAccessMode accessMode, Formatter<? extends FileSystem> formatter, DeviceParam device)
    {
