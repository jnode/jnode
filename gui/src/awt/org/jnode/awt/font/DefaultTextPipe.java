        ...
        if(font != null){
            ...
            tk.getFontManager().drawText(new Surface(){
                ...
                public void drawCompatibleRaster(Raster raster, int srcX, int srcY, int dstX, int dstY, int width, int height, Color bgColor) {
                    ...
                    BufferedImage bi = new BufferedImage(new DirectColorModel(32, 0x00ff0000, 0x0000ff00, 0x000000ff, 0xff000000),  raster.createCompatibleWritableRaster(), false, new Hashtable());
