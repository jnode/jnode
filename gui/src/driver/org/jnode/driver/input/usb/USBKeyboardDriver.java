 ...
 */
public class USBKeyboardDriver extends Driver implements USBPipeListener, USBConstants, ByteQueueProcessor {
	...
	protected void startDevice() throws DriverException {
		try {
			...
			keyEventThread = new ByteQueueProcessorThread(dev.getId() + "-daemon", keyCodeQueue, this);
