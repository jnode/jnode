...
public class Mach64Configuration extends FrameBufferConfiguration {
	...
	public static final Mach64Configuration VESA_115 = new Mach64Configuration(
			32, new DisplayMode("40000 800 840 968 1056 600 601 605 628"));

	public static final Mach64Configuration VESA_118 = new Mach64Configuration(
			32, new DisplayMode("65000 1024 1048 1184 1344 768 771 777 806"));
