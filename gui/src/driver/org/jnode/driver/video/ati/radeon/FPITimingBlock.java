...
final class FPITimingBlock {
	...
	final DisplayMode toDisplayMode(DisplayMode src, int panel_xres, int panel_yres) {
		...
		return new DisplayMode(src.getFreq(), xres, hSyncStart, hSyncEnd, hTotal,
				yres, vSyncStart, vSyncEnd, vTotal);
	}

	public String toString() {
		return "XRes:" + getXres() + ", YRes:" + getYres() + ",DotClock:"
				+ getDotClock() + ", HTotal:" + getHTotal() + ", HDisplay:"
				+ getHDisplay() + ", HSyncStart:" + getHSyncStart()
				+ ", HSyncWith:" + getHSyncWidth() + ", VTotal:" + getVTotal()
