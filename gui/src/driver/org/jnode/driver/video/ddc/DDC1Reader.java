...
public class DDC1Reader implements EDIDConstants {
	 ...
	 * @throws DDC1NoSignalException No DDC1 signal is found, the monitor does not send it, or the videocard does not support it.
	 * @throws DDC1ParseException No valid EDID datablock was found. This can be the result of a small hickup in the connection, so is does not hurd to try it again.
	 */
	 ...
	 * @return
	 */
	private int findStartBit(boolean[] bits)
	throws DDC1ParseException {
