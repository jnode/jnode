...
public interface NVidiaConstants {
	...
	public static final int NVACC_ROP_ROP3 = 0x00800300; /* 'mapped' from 0x00420300 */

	/* pattern registers */
	public static final int NV16_PAT_FIFOFREE = 0x00804010; /* little endian */
	public static final int NVACC_PAT_SHAPE = 0x00804308; /* 'mapped' from 0x00460308 */
	public static final int NVACC_PAT_COLOR0 = 0x00804310; /* 'mapped' from 0x00460310 */
	public static final int NVACC_PAT_COLOR1 = 0x00804314; /* 'mapped' from 0x00460314 */
	public static final int NVACC_PAT_MONO1 = 0x00804318; /* 'mapped' from 0x00460318 */
	public static final int NVACC_PAT_MONO2 = 0x0080431c; /* 'mapped' from 0x0046031c */

	/* clip registers */
	public static final int NV16_CLP_FIFOFREE = 0x00802010; /* little endian */
	public static final int NVACC_CLP_TOPLEFT = 0x00802300; /* 'mapped' from 0x00450300 */
	public static final int NVACC_CLP_WIDHEIGHT = 0x00802304; /* 'mapped' from 0x00450304 */

	/* used bitmap registers */
	public static final int NV16_BMP_FIFOFREE = 0x0080a010; /* little endian */
	public static final int NVACC_BMP_COLOR1A = 0x0080a3fc; /* 'mapped' from 0x006b03fc */
	public static final int NVACC_BMP_UCRECTL_0 = 0x0080a400; /* 'mapped' from 0x006b0400 */
	public static final int NVACC_BMP_UCRECSZ_0 = 0x0080a404; /* 'mapped' from 0x006b0404 */

	/*
	 * DDC1 support only requires DDC_SDA_MASK, DDC2 support requires DDC_SDA_MASK and DDC_SCL_MASK
	 */
