...
public class NVidiaVgaState extends VgaState implements NVidiaConstants {
	...
	public String toString() {
		return super.toString() +
			", arb:" + NumberUtils.hex(arb0, 2) + "," + NumberUtils.hex(arb1, 2) +
			", cursor:" + NumberUtils.hex(cursor0, 2) + "," + NumberUtils.hex(cursor1, 2) + "," + NumberUtils.hex(cursor2) +
			", repaint:" + NumberUtils.hex(repaint0, 2) + "," + NumberUtils.hex(repaint1, 2) + 
			", screen:" + NumberUtils.hex(screen, 2) +
			", horiz:" + NumberUtils.hex(horiz, 2) +
			", pixel:" + NumberUtils.hex(pixel, 2) + 
			", pll:" + NumberUtils.hex(pllsel) + "," + NumberUtils.hex(vpll) +
			", genctrl:" + NumberUtils.hex(general) + 
			", config:" + NumberUtils.hex(config) +
			", pwupctrl:" + NumberUtils.hex(pwupctrl) +
			", palmask:" + NumberUtils.hex(palmask, 2);
	}
