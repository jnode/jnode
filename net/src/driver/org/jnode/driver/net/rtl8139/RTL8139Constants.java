...
public interface RTL8139Constants
{
  ...
  public static final int INTR_MASK             = (INTR_SYS_ERR|INTR_TIMEOUT|INTR_LEN_CHG|INTR_RX_UNDERRUN|INTR_RX_BUF_OVRFLO|
                                                  INTR_RX_FIFO_OVRFLO|INTR_RX_ERR|INTR_RX_OK|INTR_TX_ERR|
                                                  INTR_TX_OK);
  ...
  public static final int RX_BUF_IDX            = 2;  // 0 = 8192, 1 = 16384; 2 = 32768, 3 = 65536;
