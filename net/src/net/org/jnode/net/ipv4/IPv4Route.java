...
public class IPv4Route implements IPv4Constants {
	 ...
	 */
	public IPv4Route(IPv4Address destination, Device device) 
	 ...
	 * @throws IllegalArgumentException If the device is not a network device.
	 */
	public IPv4Route(IPv4Address destination, IPv4Address subnetmask, IPv4Address gateway, Device device) 
	throws IllegalArgumentException {
		...
		try {
			...
			throw new IllegalArgumentException("Device " + device.getId() + " is not a network device");
		}
	}
	 ...
	 * @param on
	 * @throws IllegalArgumentException If on is true and no gateway address is set.
	 */
	public void setGateway(boolean on) 
	throws IllegalArgumentException {
		if (on) {
			if (gateway == null) {
	 ...
	 * @return The gateway address, or null is <code>isGateway</code> 
	 *   returns false
	 */
