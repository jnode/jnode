 ...
 */
public class UDPDatagramSocketImpl extends AbstractDatagramSocketImpl implements
		IPv4Constants, UDPConstants, ExSocketOptions {
	/**
	...
	protected void send(DatagramPacket p) throws IOException {
		...
		ipHdr = new IPv4Header(getTos(), getTimeToLive(), IPPROTO_UDP,
				dstAddress, p.getLength() + UDP_HLEN);
		...
		final SocketBuffer skbuf = new SocketBuffer(p.getData(), p.getOffset(),
				p.getLength());
