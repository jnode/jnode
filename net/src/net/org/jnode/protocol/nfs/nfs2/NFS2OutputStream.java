...
public class NFS2OutputStream extends OutputStream {
    ...
    public NFS2OutputStream(URL url) throws IOException {
        ...
        if (userinfo != null) {
            ...
            if (pos != -1) {
                ...
                throw new IOException(
                        "The url doesn't contains the uid and guid.");
            }
        } else {
        ...
        try {
            ...
            CreateFileResult result = nfsClient.createFile(tempFileHandle,
                    tokenList.get(tokenList.size() - 1), DEFAULT_PERMISSION,
                    uid, gid, 0, new Time(-1, -1), new Time(-1, -1));
    ...
    private void flushBuffer() throws IOException {
        ...
        try {
            fileAttribute = nfsClient.writeFile(fileHandle, (int) fileOffset,
                    buffer, 0, count);
