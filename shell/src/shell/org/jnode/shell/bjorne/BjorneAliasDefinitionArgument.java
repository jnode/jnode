...
/**
 * The BjorneAliasArgument understands 'arguments' of the form &lt;name&gt;['='[&lt;alias body&gt;]].
 * It will perform completion of the &lt;name&gt; component against the alias names
 * defined in a supplied BjorneContext.
 * 
 * @author crawley@jnode.org
 */
public class BjorneAliasDefinitionArgument extends Argument<String> {
    private final BjorneContext context;
    
    public BjorneAliasDefinitionArgument(String label, BjorneContext context, int flags, String description) {
    ...
    protected String argumentKind() {
        return "bjorne alias definition";
    }
